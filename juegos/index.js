...
const roundedDonut = () => {
    ...
    console.log("generando donut")
    donut = generateDonut();
    playStartSound();
    let rotationDegrees = 13.33;
    const percentageTransform = 400;
...
const playCorrectSound = () => {
    const tmpCorrectSound = new Audio("/accesorios/juegos/sounds/correct.wav");
    tmpCorrectSound.play();
}

const playWrongSound = () => {
    const tmpWrongSound = new Audio("/accesorios/juegos/sounds/wrong.wav");
    tmpWrongSound.play();
}

const playEndSound = () => {
    const tmpEndSound = new Audio("/accesorios/juegos/sounds/end.flac");
    tmpEndSound.play();
}

const playStartSound = () => {
    const tmpStartSound = new Audio("/accesorios/juegos/sounds/start.wav");
    tmpStartSound.play();
}
...
let formUsuario = document.querySelector(".form_usuario");
let btnJugar = document.querySelector(".jugar");
let contenedorRespuestas = document.querySelector(".contenedor_respuestas");
let btnPaso = document.querySelector(".btn_paso");
let btnResponder = document.querySelector(".btn_respuesta");


btnResponder.addEventListener("click",checkAnswer);

formUsuario.addEventListener("submit",introUsuario);
btnJugar.addEventListener("click",introUsuario);
...
let idJugador = null;
 ...
 function introUsuario(e){

    e.preventDefault();
    let nombreUsuario = document.querySelector(".apodo_usuario");
    ...
    if(apodo === "" || apodo.length < 3){
        ...
        Swal.fire({
            ...
            icon: 'error',
            title: 'Oops...',
            text: 'Debes introducir un apodo mayor a 3 caracteres',
    ...
    xhr.open("POST","/accesorios/juegos/crearJugador.php",true);
    ...
    xhr.onload = function(){
        ...
        if(xhr.status === 200){
            ...
            idJugador = respuesta.id_jugador;
            ...
            if(respuesta.resultado == "exitoso"){
                ...
                showDOMElement(pasapalabraTitleBox);
                showDOMElement(donutLetters);
                showDOMElement(contenedorRespuestas);
                showDOMElement(questionsBox);
                showDOMElement(answersBox);
                roundedDonut();
                startGame();
